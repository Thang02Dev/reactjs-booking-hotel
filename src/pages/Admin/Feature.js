...
import ModalDelete from "../../components/Admin/Features/ModalDelete";
import { Bounce, ToastContainer } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";
import { debounce } from "lodash";
import ModalCreate from "../../components/Admin/Features/ModalCreate";
import ModalUpdate from "../../components/Admin/Features/ModalUpdate";
...
const Feature = () => {
  ...
  const getById = async (id) => {
    ...
    if (response && response.status === 200) setFeature(response.data);
  };
