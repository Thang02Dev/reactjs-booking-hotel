...
import ModalDelete from "../../components/Admin/Categories/ModalDelete";
import { Bounce, ToastContainer } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";
import { debounce } from "lodash";
import ModalCreate from "../../components/Admin/Categories/ModalCreate";
  ...
  return (
    <>
      ...
      <div className="w-[100%] md:w-[100%] p-3 rounded-md bg-white">
        <p className="mb-8 mt-2 font-semibold text-[18px]">Quản Lý Danh Mục</p>
